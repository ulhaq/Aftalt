...
$('a[href="#top"]').css({"display":"none","opacity":"0.7","bottom":"50px","right":"10px","position":"fixed","height":"49px","width":"49px","background":"url(http://aftalt.dk/styles/funall.png) no-repeat -1px -89px"});
